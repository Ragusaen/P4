...
class  OperatorType {
    companion object{
        ...
        private val typeRules = listOf(
                ...
                TypeRule(Type.Float, Operator.MULTIPLICATION, Type.Time, Type.Time),
                TypeRule(Type.Time, Operator.MULTIPLICATION, Type.Float, Type.Time),
                ...
                TypeRule(Type.Time, Operator.DIVISION, Type.Float, Type.Time),
